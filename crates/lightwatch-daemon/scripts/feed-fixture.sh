...
cat >"$fixture" <<'STREAM'
{"msg":"hello","schema":1,"app":"lightphotos","pid":3218,"started_unix_ms":1700000000000,"window_ms":100,"source":"lightwatch-probe"}
{"msg":"frame","seq":0,"t_ns":0,"registers":[{"kind":"function","id":1,"name":"thumbnail::get_or_make","module":"lightphotos","location":{"file":"src/thumbnail.rs","line":407,"column":12}},{"kind":"function","id":2,"name":"decode::jpeg","module":"lightphotos"},{"kind":"type","id":1,"name":"Thumbnail"}]}
{"msg":"frame","seq":1,"t_ns":100000000,"events":[{"kind":"calls","func":1,"count":16,"ns":{"enc":"raw","v":[2110000,5750000]}},{"kind":"edge","from":1,"to":2,"count":16},{"kind":"census","ty":1,"live":3,"bytes":900,"sizes":{"enc":"raw","v":[300,300,300]}}]}
this line is not json and must not kill the connection
{"msg":"frame","seq":2,"t_ns":200000000,"events":[{"kind":"calls","func":1,"count":24,"ns":{"enc":"raw","v":[1900000,2400000]}},{"kind":"edge","from":1,"to":2,"count":24},{"kind":"census","ty":1,"live":9,"bytes":2700,"sizes":{"enc":"raw","v":[300,300,300,300,300,300,300,300,300]}}]}
...
{"msg":"frame","seq":7,"t_ns":400000000,"events":[{"kind":"calls","func":2,"count":8,"ns":{"enc":"raw","v":[9100000]}},{"kind":"edge","from":2,"to":1,"count":2},{"kind":"census","ty":1,"live":5,"bytes":1500,"sizes":{"enc":"raw","v":[300,300,300,300,300]}}]}
STREAM
